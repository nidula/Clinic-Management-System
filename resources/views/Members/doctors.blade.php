...
<body>
                ...
                <div class="col-lg-12">
                    <div class="breadcrumb_iner">
                        <div class="breadcrumb_iner_item">
                            <center><img src="frontendmem/img/rdoctor.png" alt="" height="200" width="200"></center>
                            <h1 style="color:white;font-size:50px;"align="center">Registered Doctors</h1>
    ...
    <section>
        ...
        $("#myInput").on("keyup", function() {
            ...
            <form method="POST" action="DocSpec" enctype="multipart/form-data" class="form" style="text-align:center;">
            @csrf
            <div class="form-group row justify-content-center">
                            <label for="specification" class="col-md-2 col-form-label"><strong>Specification</strong></label>

                            <div class="col-md-2">
                            <select class="form-control col-md-12" id="specification" name="specification" required>
