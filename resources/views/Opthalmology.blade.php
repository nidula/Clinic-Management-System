        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 pt-5 ftco-animate">
          	<div class="mt-5">
	            ...
	            <h1 class="mb-4">Ophthalmology</h1>
	            <p class="mb-4" style="text-align: justify; color: #000">All evaluations that purport to diagnose eye disease should be carried out by a physician.  An ophthalmologist is a doctor of medicine who specializes in the diagnosis and treatment of disorders of the eye, in addition to diagnosing systemic disease that manifest in eye signs or symptoms. Since ophthalmologists perform operations on eyes, they are considered to be both surgical and medical specialists. In fact, the only health professional trained both medically and surgically to treat eye disorders. Especially the most serious eye diseases such as macular degeneration, diabetic retinopathy and glaucoma is an ophthalmologist.</p>
