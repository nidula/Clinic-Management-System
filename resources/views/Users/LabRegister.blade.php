...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Laboratory Registration') }}</div>

                <div class="card-body">
                    <form method="POST" action="submitlab" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="regno" type="text" class="form-control" name="regno" value="{{ old('regno') }}" required autocomplete="regno" autofocus>
                            </div>
                        </div>
                        ...
                        <input id="doctor" type="hidden" class="form-control" name="category" value="Lab" required>
