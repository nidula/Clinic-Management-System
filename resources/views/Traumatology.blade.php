        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 pt-5 ftco-animate">
          	<div class="mt-5">
	            ...
	            <h1 class="mb-4">Traumatology</h1>
	            <p class="mb-4" style="text-align: justify; color: #000">In medicine, traumatology (from Greek trauma, meaning injury or wound) is the study of wounds and injuries caused by accidents or violence to a person, and the surgical therapy and repair of the damage. Traumatology is a branch of medicine. It is often considered a subset of surgery and in countries without the specialty of trauma surgery it is most often a sub-specialty to orthopedic surgery. Traumatology may also be known as accident surgery.</p>
              <p class="mb-4" style="text-align: justify; color: #000">Traumatologist a physician (such as an orthopedic surgeon) specializing in the treatment of severe, acute physical injuries (as from a car accident or gunshot wound) sustained by individuals requiring immediate medical attention</p>
