    ...
    <div class="row justify-content-center">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
            @if($row->dochide)
            <a href="/docunhide/{{$row->id}}"><button type="button"class="btn btn-success">Unhide</button></a>
            @else
            <a href="/dochide/{{$row->id}}"><button type="button"class="btn btn-warning">Hide</button></a>  
            @endif
          </td>
          <td>
