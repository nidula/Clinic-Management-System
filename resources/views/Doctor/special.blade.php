...
@section('content')
    <div class="row justify-content-center">
        ...
        <tbody>
          ...
          <td>
            @if($row->special)
            <a href="/sunspecial/{{$row->id}}"><button type="button"class="btn btn-warning">UnSpecial</button></a>
            @else
            <a href="/sspecial/{{$row->id}}"><button type="button"class="btn btn-success">Special</button></a>  
            @endif
          </td>
          <td>
