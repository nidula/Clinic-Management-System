        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 pt-5 ftco-animate">
          	<div class="mt-5">
	            ...
	            <h1 class="mb-4">X-Ray</h1>
	            <p class="mb-4" style="text-align: justify; color: #000">X-rays are a form of electromagnetic radiation, similar to visible light. Unlike light, however, x-rays have higher energy and can pass through most objects, including the body. Medical x-rays are used to generate images of tissues and structures inside the body. If x-rays travelling through the body also pass through an x-ray detector on the other side of the patient, an image will be formed that represents the “shadows” formed by the objects inside the body.</p>
              <p class="mb-4" style="text-align: justify; color: #000">One type of x-ray detector is photographic film, but there are many other types of detectors that are used to produce digital images. The x-ray images that result from this process are called radiographs. Medical x-rays used of Mammogram, Fluoroscopy and for CT Scans.</p>
